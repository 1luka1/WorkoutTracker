...
namespace Domain.Entities
{
    public class Workout
    {
        ...
        public Workout(int userId, ExerciseType exerciseType, int durationMinutes, int caloriesBurnt, int weightIntensity, int fatigue, string? notes, DateTime workoutDateTime)
        {
            if (userId <= 0)
